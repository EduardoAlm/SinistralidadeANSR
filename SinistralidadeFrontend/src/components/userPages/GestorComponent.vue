<template>
  <div class="w3-container">
   ...
   overflow:auto;">
      ...
      <p>&nbsp;</p>
      <button class="w3-button w3-green w3-round w3-margin-right" @click="modalCreateAcidente()">Criar</button>
...
export default {
  ...
  methods: {
    ...
    updateAcidente: async function() { 
      ...
      console.log(this.km);
      console.log(this.natureza);
      console.log(await this.$store.dispatch("update_acidente", this.id, "cenas", this.mortos, this.feridosg, this.via, this.km, this.natureza));
      this.myInput=this.concelho;
      this.getAc(this.concelho);
      this.id = 0;
      this.concelho = "Selecione o seu concelho";
